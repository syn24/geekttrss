...
public final class SetPublishedAction_Factory {
  ...
  private SetPublishedAction_Factory(Provider<CoroutineDispatchersProvider> dispatchersProvider,
  ...
  public SetPublishedAction get(long articleId, boolean newValue, CoroutineScope scope) {
  ...
  public static SetPublishedAction_Factory create(
      Provider<CoroutineDispatchersProvider> dispatchersProvider,
      Provider<ArticleDao> articleDaoProvider, Provider<TransactionsDao> transactionsDaoProvider,
      Provider<ApiService> apiServiceProvider) {
    return new SetPublishedAction_Factory(dispatchersProvider, articleDaoProvider, transactionsDaoProvider, apiServiceProvider);
  }

  public static SetPublishedAction newInstance(CoroutineDispatchersProvider dispatchers,
    ...
    return new SetPublishedAction(dispatchers, articleDao, transactionsDao, apiService, articleId, newValue, scope);
  }
}
