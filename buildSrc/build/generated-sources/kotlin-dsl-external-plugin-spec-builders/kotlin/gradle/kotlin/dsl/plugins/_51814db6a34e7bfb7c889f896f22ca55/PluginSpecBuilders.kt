...
package gradle.kotlin.dsl.plugins._51814db6a34e7bfb7c889f896f22ca55
...
/**
 * The `com.geekorum` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComGeekorumPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.geekorum`.
 */
internal
val `ComPluginGroup`.`geekorum`: `ComGeekorumPluginGroup`
    get() = `ComGeekorumPluginGroup`(plugins)


/**
 * The `com.geekorum.gradle` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComGeekorumGradlePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.geekorum.gradle`.
 */
internal
val `ComGeekorumPluginGroup`.`gradle`: `ComGeekorumGradlePluginGroup`
    get() = `ComGeekorumGradlePluginGroup`(plugins)


/**
 * The `com.geekorum.gradle.avdl` plugin implemented by [com.geekorum.gradle.avdl.AvdlPlugin].
 */
internal
val `ComGeekorumGradlePluginGroup`.`avdl`: PluginDependencySpec
    get() = plugins.id("com.geekorum.gradle.avdl")
...
/**
 * The `com.github.hierynomus` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComGithubHierynomusPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.github.hierynomus`.
 */
internal
val `ComGithubPluginGroup`.`hierynomus`: `ComGithubHierynomusPluginGroup`
    get() = `ComGithubHierynomusPluginGroup`(plugins)


/**
 * The `com.github.hierynomus.license` plugin implemented by [nl.javadude.gradle.plugins.license.LicensePlugin].
 */
internal
val `ComGithubHierynomusPluginGroup`.`license`: PluginDependencySpec
    get() = plugins.id("com.github.hierynomus.license")


/**
 * The `com.github.hierynomus.license-base` plugin implemented by [com.hierynomus.gradle.license.LicenseBasePlugin].
 */
internal
val `ComGithubHierynomusPluginGroup`.`license-base`: PluginDependencySpec
    get() = plugins.id("com.github.hierynomus.license-base")


/**
 * The `com.github.hierynomus.license-report` plugin implemented by [com.hierynomus.gradle.license.LicenseReportingPlugin].
 */
internal
val `ComGithubHierynomusPluginGroup`.`license-report`: PluginDependencySpec
    get() = plugins.id("com.github.hierynomus.license-report")


/**
 * The `com.github.triplet` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComGithubTripletPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.github.triplet`.
 */
internal
val `ComGithubPluginGroup`.`triplet`: `ComGithubTripletPluginGroup`
    get() = `ComGithubTripletPluginGroup`(plugins)


/**
 * The `com.github.triplet.play` plugin implemented by [com.github.triplet.gradle.play.PlayPublisherPlugin].
 */
internal
val `ComGithubTripletPluginGroup`.`play`: PluginDependencySpec
    get() = plugins.id("com.github.triplet.play")
...
/**
 * The `license` plugin implemented by [nl.javadude.gradle.plugins.license.LicensePlugin].
 */
internal
val `PluginDependenciesSpec`.`license`: PluginDependencySpec
    get() = this.id("license")
